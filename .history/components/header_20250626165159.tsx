  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 px-6 py-4 w-full h-[84px]">
      <div className="flex items-center justify-between w-full">
        ...
        <DropdownMenu >
          <DropdownMenuTrigger className="border-none flex items-center gap-3 text-gray-900 hover:text-gray-600 focus:outline-none">
          ...
          <DropdownMenuContent align="end" className="bg-[#272727] *:text-white border-gray-200 w-64">
            <div className="px-4 py-3 border-b border-gray-200">
              ...
              <div className="text-sm text-gray-300 capitalize">{session?.user?.role}</div>
            </div>
            <DropdownMenuItem asChild className="text-gray-700 hover:text-gray-900 hover:bg-gray-50 px-4 py-3 border-b border-gray-200">
            ...
            <DropdownMenuItem
              ...
              className="text-gray-700 hover:text-gray-900 hover:bg-gray-50 px-4 py-3 border-b border-gray-200"
            >
            ...
            <DropdownMenuItem
              ...
              className="text-red-600 hover:text-gray-900 hover:bg-gray-50 px-4 py-3"
            >
