              ...
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.title} className="px-4">
                  <SidebarMenuButton
                    ...
                    className={`w-full justify-start px-4  text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors ${
                      pathname === item.url ? "!bg-[#111] !text-white font-medium" : ""
                    }`}
                  >
                    <Link href={item.url} className="flex items-center gap-3 my-5">
