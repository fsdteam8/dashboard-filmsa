      ...
      <div className="p-6 space-y-6 w-full">
        <div className="flex items-center justify-between w-full">
          ...
          <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            ...
            <DialogContent className="bg-[#272727] border-none text-white">
              {/* <DialogHeader>
        ...
        >
          <CardContent className="p-0">
            <Table>
              <TableHeader>
                <TableRow className="*:text-[#E7E7E7] *:text-lg hover:bg-black">
                ...
                <TableBody>
                  {genresData &&
                    genresData?.map((genre: Genre) => (
                      <TableRow
                        key={genre.id}
                        className="bg-[#272727] hover:bg-black *:text-white mt-10"
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              className="text-gray-100 hover:text-white hover:bg-transparent"
                            >
                            ...
                            <Button
                              ...
                              className="text-gray-100 hover:text-red-400 hover:bg-transparent"
                            >
